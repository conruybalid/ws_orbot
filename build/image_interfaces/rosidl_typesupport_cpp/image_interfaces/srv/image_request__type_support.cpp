...
static const _ImageRequest_Request_type_support_symbol_names_t _ImageRequest_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, image_interfaces, srv, ImageRequest_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, image_interfaces, srv, ImageRequest_Request)),
  }
};
...
{
  return &::image_interfaces::srv::rosidl_typesupport_cpp::ImageRequest_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, image_interfaces, srv, ImageRequest_Request)() {
  return get_message_type_support_handle<image_interfaces::srv::ImageRequest_Request>();
}
...
static const _ImageRequest_Response_type_support_symbol_names_t _ImageRequest_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, image_interfaces, srv, ImageRequest_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, image_interfaces, srv, ImageRequest_Response)),
  }
};
...
{
  return &::image_interfaces::srv::rosidl_typesupport_cpp::ImageRequest_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, image_interfaces, srv, ImageRequest_Response)() {
  return get_message_type_support_handle<image_interfaces::srv::ImageRequest_Response>();
}
...
static const _ImageRequest_type_support_symbol_names_t _ImageRequest_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, image_interfaces, srv, ImageRequest)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, image_interfaces, srv, ImageRequest)),
  }
};
...
{
  return &::image_interfaces::srv::rosidl_typesupport_cpp::ImageRequest_service_type_support_handle;
}
